...
export class AppSettings {
    ...
    // public static API_ENDPOINT = 'demo.artinove.ma/Sbp_API';
    ...
    static RequestOptions() {
        return {
            headers: new HttpHeaders({
                ...
                'Authorization': localStorage.getItem("SBP_client_token") != null ? localStorage.getItem("SBP_client_token") : ""
            })
        };
    }

    /* Name var localstorage */
    static TOKEN = 'SBP_client_token'
    static USER = 'SBP_client_USER';

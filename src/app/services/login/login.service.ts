...
export class LoginService {
  ...
  logout(): void {
    localStorage.removeItem('SBP_client_token');
  }

  isAuthenticated() {
    return localStorage.getItem('SBP_client_token') != null ? true : false;
  }
  ...
  getUser(): User {
    return localStorage.getItem("SBP_client_USER") != null ? JSON.parse(localStorage.getItem("SBP_client_USER")) as User : null
  }
}
